  ...
  begin
    ...
    case s[pos] of
      ...
      begin
        ...
        if con = 'tang' then num := 12;
        if con = 'cotg' then num := 13;
        ...
        if con = 'asin' then num := 19;
        if con = 'acos' then num := 20;
        if con = 'atang' then num := 21;
        if con = 'acotg' then num := 22;
        if con = 'sinh' then num := 23;
        if con = 'cosh' then num := 24;
        if con = 'tangh' then num := 25;
        if con = 'cotgh' then num := 26;
